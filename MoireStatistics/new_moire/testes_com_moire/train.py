...
def main(args):
    ...
    X_LL_train, X_LH_train, X_HL_train, X_HH_train, Y_train, X_LL_test, X_LH_test, X_HL_test, X_HH_test, Y_test, height, width, depth, num_classes = trainTestSplit(X_LL, X_LH, X_HL, X_HH, X_index, Y, imageCount)
    
    
    model = trainCNNModel(X_LL_train, X_LH_train, X_HL_train, X_HH_train, Y_train, X_LL_test, X_LH_test, X_HL_test, X_HH_test, Y_test, height, width, depth, num_classes, numEpochs)
...
def trainCNNModel(X_LL_train, X_LH_train, X_HL_train, X_HH_train, Y_train, X_LL_test, X_LH_test, X_HL_test, X_HH_test, Y_test, height, width, depth, num_classes, num_epochs):
    ...
    model.fit([X_LL_train, X_LH_train, X_HL_train, X_HH_train], Y_train, batch_size=batch_size, epochs=num_epochs, verbose=1, validation_split=0.1, callbacks=callbacks_list)

    
    
    score, acc = model.evaluate([X_LL_test, X_LH_test, X_HL_test, X_HH_test], Y_test, verbose=1)
